...
namespace Microsoft.SpecExplorer.ErrorReporting
{
    public class ErrorReportBuilder
    {
          ...
          Exception exception)
        {
            ...
            int num1 = NativeMethods.WerReportSetParameter(phReportHandle, 0U, "AppName", "Spec Explorer");
            if (num1 != 0)
            {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        int num4 = NativeMethods.WerReportSetParameter(phReportHandle, 3U, "AsmAndModName", "MainAssemblyName");
                        if (num4 != 0)
                        {
