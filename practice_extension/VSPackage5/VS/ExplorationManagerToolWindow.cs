...
namespace Microsoft.SpecExplorer.VS
{
  ...
  public class ExplorationManagerToolWindow : ToolWindowPane
  {
    ...
    {
      this.Caption = Resources.ExplorationManagerToolWindowTitle;
    ...
    {
      if (PostProcessorHelper.LoadCustomizedPostProcessingTypes(Path.Combine(this.package.Session.InstallDir, Resources.ExtensionDirectoryName), (IHost) this.package, out this.postProcessorTypeMap, out this.postProcessorDisplayNameMap))
        return;
    ...
    private void OnValidate(object sender, EventArgs e)
    {
      ...
      this.control.ProgressMessage(Resources.ValidationInProgress);
      this.package.ProgressMessage((VerbosityLevel) 0, Resources.ValidationInProgress);
      ...
      if (num > 0)
      {
        ...
        this.control.ProgressMessage(Resources.ValidationFailed);
      ...
      else
      {
        ...
        this.control.ProgressMessage(Resources.ValidationSucceeded);
        this.control.FinishOperation();
      }
    }
    ...
    internal void AbortOperation()
    {
      ...
      if (this.workerThread == null || this.workerThread.Join(1000))
        return;
      this.package.NotificationDialog(Resources.SpecExplorer, Resources.AbortingExploration);
    ...
    private void OnNavigateToMachine(object sender, MachineEventArgs e)
    {
      ...
      this.package.NotificationDialog(Resources.SpecExplorer, string.Format("Cannot navigate to machine '{0}'.", (object) machine.Name));
    }
    ...
    private void Work(TaskTypes taskType, MachineEventArgs e, string replayFilePath = null)
    {
      this.workerThread = new System.Threading.Thread((ThreadStart) (() =>
      {
        ...
        catch (ThreadAbortException ex)
        {
          ...
          this.control.ProgressMessage(Resources.AbortingExploration);
