...
// Type: Microsoft.VisualStudio.PlatformUI.MultiValueConverter`5
...
{
  public class MultiValueConverter<TSource1, TSource2, TSource3, TSource4, TTarget> : IMultiValueConverter
  {
    public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
    {
      if (values.Length != 4)
        throw new ArgumentException(string.Format((IFormatProvider) CultureInfo.CurrentCulture, Resources.Error_InsufficientSourceParameters, (object) 4));
      ...
      return (object) this.Convert((TSource1) values[0], (TSource2) values[1], (TSource3) values[2], (TSource4) values[3], parameter, culture);
    }
      ...
      CultureInfo culture)
    {
      if (targetTypes.Length != 4)
        throw new ArgumentException(string.Format((IFormatProvider) CultureInfo.CurrentCulture, Resources.Error_InsufficientTypeParameters, (object) 4));
      ...
      TSource3 out3;
      TSource4 source4;
      this.ConvertBack((TTarget) value, out out1, out out2, out out3, out source4, parameter, culture);
      return new object[4]
      {
        (object) out1,
        (object) out2,
